              ...
              <Col>
                <Card className="banner__item">
                  ...
                  <p className="banner__paragraph">
                    ...
                    These examples are categorized by difficulty and will be
                    shown to you, according to your level, to maximize your
                    learning efficiency.
                  </p>
                </Card>
              </Col>
              <Col>
                <Card className="banner__item">
                  ...
                  <p className="banner__paragraph">
                    ...
                    life. It will provide you with entertaining content
